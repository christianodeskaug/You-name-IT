...
1. Programmer i go utføres med kommandoet go run Da genereres det ingen objektfil (en fil som man kan utføre på en platform,
...
Vi ser ingen tegn eller bruk av semikolon i koden
